...
class GestionDonnees:
    ...
    def recuperer_donnees(self):
        ...
        Returns:
            x_train [np.array]: matrice contenant les donn�es d'entra�nement
            t_train [np.array]: matrice contenant les r�sultats attendus de nos donn�es d'entra�nement
    ...
    def mise_en_forme_classes(self, classes, labels_train):
        ...
        Args:
            ...
            labels_train (np.array): Liste de toutes nos classes qui correspondent aux différentes données d'entrainement

        Returns:
            labels_train_modifie (np.array): Liste de l'indice de nos classes qui correspondent aux différentes données d'entrainement
            labels_train_preApprentissage (np.array): liste des noms des classes de chaque �l�ments avant la phase d'entrainement
        """
